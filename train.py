...
if __name__ == '__main__':
    ...
    train_data_dir = os.path.join(data_dir, "TRAINSAMPLE")
    dev_data_dir = os.path.join(data_dir, "DEVALL")
    ...
    train_labels = [1 if "YES" in f else 0 for f in train_filenames]
    eval_labels = [1 if "YES" in f else 0 for f in eval_filenames]
